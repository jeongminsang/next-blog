...
일단 노션은 협업에서도 사용되고 개인 필기용으로도 많이 사용되는 서비스인데, NotionAPI는 DB 필요없이 노션 자체가 DB 역할을 하며 그 DB를 공개할 수 있다는 점에 있어서 굉장히 이점이 있다. 이론상 Firebase 상위호환이라 할 수 있겠다.
...
![](https://velog.velcdn.com/images/minsang9735/post/b2df4278-dc2e-4246-8edc-77e083eaefa6/image.png)
노션 공식문서 API Reference에 예시가 다 나와있으니 참고할 것.

일단 postman 에서 테스트를 해보자면
![](https://velog.velcdn.com/images/minsang9735/post/9c472b0d-4a23-4bed-9ce0-50667a93981a/image.png)

??? 는 아까 URL에서 찾은 데이터베이스 키이고 아래 토큰은 integration만들때 발급한 시크릿 키이다.

![](https://velog.velcdn.com/images/minsang9735/post/a3fbcb3b-df47-4ef2-9a1d-e215c267d8a7/image.png)
그리고 공식문서처럼 Notion-Version 을 꼭 넣어줘야 한다. ~~안하면 에러남~~

![](https://velog.velcdn.com/images/minsang9735/post/53491215-a1c0-43d2-8ae8-6fa415ebd660/image.png)
...
![](https://velog.velcdn.com/images/minsang9735/post/5d5660f8-56be-4705-8274-e8452c943042/image.png)
