...
![](https://velog.velcdn.com/images/minsang9735/post/e9732870-4599-4984-9913-b4883ddc2f2c/image.png)

소스코드를 까보면 enableCssLayer가 true 일 경우, 전체 스타일을 [@layer](https://developer.mozilla.org/en-US/docs/Web/CSS/@layer) 로 그냥 묶기만 한다.
